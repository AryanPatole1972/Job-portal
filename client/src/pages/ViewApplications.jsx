                    ...
                    {viewApplicationsPageData.map((applicant,index)=>(
                     <tr key={index} className='text-gray-700'> 
                         ...
                         <td className='py-2 px-4 border-b text-center flex' >
                            <img className='w-10 rounded-full mr-3 max-sm:hidden' src={applicant.imgSrc} alt="" />
                         ...
                         <td className='py-2 px-4 border-b'>
                            <a href=""target='_blank'
                              className='bg-blue-50 text-blue-400 px-3 py-1 rounded inline-flex gap-2 iteems-center'
                            >
